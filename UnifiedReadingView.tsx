...
export const UnifiedReadingView: React.FC<UnifiedReadingViewProps> = ({
  ...
  const [report, setReport] = useState<SynthesisReport>(() => selectedReport || INITIAL_REPORTS[0]);
    ...
    >
          ...
          >
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2 text-center text-xs">
                <motion.div whileHover={{ y: -2 }} className="p-2.5 bg-black rounded-xl border border-white/10">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <motion.div 
            whileHover={{ y: -3 }}
            className="p-4 bg-white/5 rounded-xl border border-white/10 space-y-1 transition-colors hover:border-purple-500/40"
          >
          ...
          <motion.div 
            whileHover={{ y: -3 }}
            className="p-4 bg-white/5 rounded-xl border border-white/10 space-y-1 transition-colors hover:border-pink-500/40"
          >
          ...
          <motion.div 
            whileHover={{ y: -3 }}
            className="p-4 bg-white/5 rounded-xl border border-white/10 space-y-1 transition-colors hover:border-emerald-500/40"
          >
