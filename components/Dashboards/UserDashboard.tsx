...
export const UserDashboard: React.FC<UserDashboardProps> = ({ currentUser, onOpenReport }) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-4">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            ...
            <span className="text-xs text-slate-400">{INITIAL_REPORTS.length} Saved</span>
          </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-bold text-sm text-white group-hover:text-indigo-300 transition-colors">
                      {rep.personality.archetype} Synthesis
                    </div>
